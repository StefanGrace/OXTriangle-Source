...
// Level Messages
global.text_message_level[0] = "Weiß steht für Fels."
global.text_message_level[1] = "A kills X, but can be killed by Triangle."
global.text_message_level[2] = "Neutrale Charaktere können vom Äther-Spieler erfasst werden."
global.text_message_level[4] = "Dies ist ein Felsbrocken, der beim Schieben herunterfällt."
global.text_message_level[5] = "Dieser Zorn gibt dir die Kraft, 5 Züge lang alles zu töten."
...
global.text_message_level[10] = "Das ist eine Bombe. Wenn es fällt, bläst es einen Tunnel."
global.text_message_level[11] = "B kann 4er Kisten infiltrieren."
global.text_message_level[12] = "Orange Wut lässt dich rocken."
global.text_message_level[13] = "E tötet O und Square und kann durch Fels und Diamant nach unten tunneln."
global.text_message_level[14] = "Barrieren können nicht durchfahren werden."
...
global.text_message_level[19] = "Pfeilplättchen können nur in 1 Richtung durchlaufen werden."
global.text_message_level[20] = "R feuert Pfeile bis zu 5 Kacheln entfernt ab."
global.text_message_level[21] = "M explodiert und zerstört 9 Kacheln."
global.text_message_level[22] = "Mit Blue Anger können Charaktere Diamanten tunneln."
...
if (global.levelnumber<10)
{
    if (file_exists("Backgrounds\0_Waterfall.jpg"))
    {
        ...
        if (argument0==0 and global.show_backgrounds) instance_create(0,0,Background_Object)
    }
    else 
    {
        background_index[0] = -1
...
if (argument0 > 1) {y_plus = floor(sprite_height/2); x_plus = floor(sprite_width/2)}
